package PDL::Graphics::ColorObject;
...
PDL::Graphics::ColorObject - convert between color spaces


=head1 SYNOPSIS

  use PDL::Graphics::ColorObject;
  
  # rgb to hsv
  $color = PDL::Graphics::ColorObject->new_RGB([$r, $g, $b]);
  ($h, $s, $v) = @{ $color->as_HSV() };
  
  # one rgb space to another (NTSC to PAL)
  $color = PDL::Graphics::ColorObject->new_RGB([$r, $g, $b], space=>'NTSC');
...
The constructor can always take a hash of optional arguments in addition to the color value, namely the working RGB space and the white point.  For example:
  ...
  $color = PDL::Graphics::ColorObject->new_RGB([$r, $g, $b], space=>'Adobe', white_point=>'D65');

For a list of all supported color spaces, call PDL::Graphics::ColorObject->list_colorspaces().  For a list of all RGB working spaces and of all white points that this module supports, call PDL::Graphics::ColorObject->list_rgb_spaces() and PDL::Graphics::ColorObject->list_white_points().
...
=head2 $color = PDL::Graphics::ColorObject->new_XYZ([$X, $Y, $Z])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_xyY([$x, $y, $Y])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_RGB([$R, $G, $B])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_RGB255([$R, $G, $B])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_RGBhex($rgbhex)
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_Lab([$L, $a, $b])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_LCHab([$L, $C, $H])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_Luv([$L, $u, $v])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_LCHuv([$L, $C, $H])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_HSL([$H, $S, $L])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_HSV([$H, $S, $V])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_CMY([$C, $M, $Y])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_CMYK([$C, $M, $Y])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_YPbPr([$Y, $Pb, $Pr])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_YCbCr([$Y, $Cb, $Cr])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_YUV([$Y, $Cb, $Cr])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_YIQ([$Y, $I, $Q])
=cut 
...
=head2 $color = PDL::Graphics::ColorObject->new_PhotoYCC([$Y, $C1, $C2])
=cut 
...
Alfred Reibenschuh E<lt>alfredreibenschuh@yahoo.comE<gt> for the previous versions of PDL::Graphics::ColorObject, and for the HSL/HSV/CMYK code.
